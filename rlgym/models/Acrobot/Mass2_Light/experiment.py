...
def make_experiment(param_root, 
                    ...
                    result_path='./GeneratedAgents/Acrobot/', save=False):
    """
    ...
    #Load Representation
    if (params.representation == "rlpy.Representations.RandomLocalBases" or 
        params.representation == "Representations.ModifiedRandomLocalBases"):
...
if __name__ == '__main__':
    experiment = make_experiment(sys.argv[1], yaml_file="params2.yml", save=True)
