...
class RCCarDynamics(RCCarModified):

    """
    This has logic for replacing the dynamics
    ...
    **REFERENCE:**
    ...
    HEADINGMIN = -np.pi
    HEADINGMAX = np.pi
    INIT_STATE = np.array([-1.0, -1.0, 0.0, 0.])
    ...
    def __init__(self, angle=None, **kwargs):
        ...
        super(RCCarDynamics, self).__init__(**kwargs)
